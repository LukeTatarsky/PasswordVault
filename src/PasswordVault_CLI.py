    ...
    while True:
        try:
            ...
            print(
                ...
                f"   4. Edit Note          Q) Cancel (discard changes) \n"
...
def main():
    ...
    while True:
            ...
            if vault_key == b'' and encrypted_entries == {} and vault_salt == b'':
                wipe_terminal()
                continue
            ...
            while True:
                try:
                    ...
                    print("\n--- Main Menu ---")
                    print("\n 1) New Entry    2) Get Entry    4) More Options   Q) Quit")
                    choice = input(" > ").strip().lower()
                    print()
                    ...
                    # == AUDIT VAULT ===================================
                        ...
                        audit_vault(encrypted_entries, vault_key,
                                    ...
                                    test_reuse=t_reuse, strength_threshold=100)
